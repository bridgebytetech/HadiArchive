...
export default function NewWritingPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (payload: any) => writingService.create(payload),
    onSuccess: () => {
      toast.success("Writing created");
  ...
  return (
    <AdminLayout>
      <AdminPageHeader title="Add Writing" backHref="/admin/writings" />
            ...
            <form onSubmit={handleSubmit((d) => createMutation.mutate(d))} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <Input {...register("writingType")} placeholder="ARTICLE/COLUMN/..." />
                </div>
                <div className="space-y-2">
                  <Label>Date</Label>
